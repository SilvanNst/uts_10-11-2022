...
<head>
    ...
    <title>Welcome To Dashboard Paswa 2022</title>
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="dashboard.php">
                <div class="sidebar-brand-icon rotate-n-10"> <a class="navbar-brand mx-4 mb-3">
                    <img src="assets/img/paswa.png" alt="" style="width: 150px; height: 150px;">
                </div>
